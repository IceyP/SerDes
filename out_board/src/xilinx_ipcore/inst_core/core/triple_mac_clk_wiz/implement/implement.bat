...
xst -ifn xst.scr
move triple_mac_clk_wiz_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\triple_mac_clk_wiz_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc triple_mac_clk_wiz_exdes.ucf triple_mac_clk_wiz_exdes

echo 'Running map'
map -timing -pr b triple_mac_clk_wiz_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm triple_mac_clk_wiz_exdes -w routed.ncd routed.v
cd ..
