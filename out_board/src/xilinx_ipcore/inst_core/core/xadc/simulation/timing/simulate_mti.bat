...
vlog -work work xadc_tb.v

REM run the simulation
vsim -c -t ps +transport_int_delays -voptargs="+acc" -L secureip -L simprims_ver -sdfmax xadc_tb\dut=..\..\implement\results\routed.sdf +no_notifier work.xadc_tb work.glbl
