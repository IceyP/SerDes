...
vlogcomp -work work ../../../fifo_w16_d512.v
vhpcomp -work work ../../example_design/fifo_w16_d512_exdes.vhd
...
fuse work.fifo_w16_d512_tb work.glbl -L xilinxcorelib_ver -L unisims_ver -o fifo_w16_d512_tb.exe

./fifo_w16_d512_tb.exe -gui -tclbatch ./simcmds.tcl
