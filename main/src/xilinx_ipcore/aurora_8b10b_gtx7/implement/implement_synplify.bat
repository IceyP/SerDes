...
COPY aurora_8b10b_gtx7_exdes.edf .\results\

ECHO Copying files from example design directory to the results directory
COPY ..\example_design\aurora_8b10b_gtx7_exdes.ucf .\results\
CD results
...
ngdbuild aurora_8b10b_gtx7_exdes

REM  -----------------------------------------------------------------------------
REM-------------------------------Run map-------------------------------------------

ECHO 'Running map'
map -detail aurora_8b10b_gtx7_exdes -o mapped.ncd
...
ECHO INFO:Implementation is complete for aurora_8b10b_gtx7_exdes
