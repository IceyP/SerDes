...
vlogcomp -work work ..\..\example_design\traffic_gen_check\aurora_8b10b_gtx2_frame_check.v
vlogcomp -work work ..\..\example_design\traffic_gen_check\aurora_8b10b_gtx2_frame_gen.v   
