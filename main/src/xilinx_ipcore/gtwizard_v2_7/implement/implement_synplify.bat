...
ngdbuild -uc ..\..\example_design\gtwizard_v2_7_exdes.ucf -p xc7k70t-fbg676-2 gtwizard_v2_7_exdes.edf gtwizard_v2_7_exdes.ngd
...
ECHO 'Running NGD'
map -p xc7k70t-fbg676-2 -o mapped.ncd gtwizard_v2_7_exdes.ngd
