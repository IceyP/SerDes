...
xst -ifn xst.scr
move s6_pll_27m_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\s6_pll_27m_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc s6_pll_27m_exdes.ucf s6_pll_27m_exdes

echo 'Running map'
map -timing -pr b s6_pll_27m_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm s6_pll_27m_exdes -w routed.ncd routed.v
cd ..
